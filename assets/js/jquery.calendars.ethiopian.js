(function($) { // Hide scope, no $ conflict
	...
	/** Implementation of the Ethiopian calendar.
		...
		@param {string} [language=''] The language code (default English) for localization. */
	...
	$.extend(EthiopianCalendar.prototype, {
		...
		regionalOptions: { // Localisations
			'': {
				...
				monthNamesShort: ['Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Pag'],
			...
			'am': {
				...
				digits: $.calendars.substituteEthiopianDigits(['','፩','፪','፫','፬','፭','፮','፯','፰','፱'],['','፲','፳','፴','','','','']),
				// digits: null,
				dateFormat: 'dd/mm/yyyy',
				firstDay: 0,
				isRTL: false
